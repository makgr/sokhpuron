                              ...
                              <Col className="shadow-sm bg-white pb-3 mt-4" md={12} lg={12} sm={12} xs={12}>
                                   ...
                                   <Row>
                                        ...
                                        <Col className="" md={6} lg={6} sm={12} xs={12}>
                                             ...
                                             <p className=" p-0 m-0"><span className="Review-Title">Mohammad Ali Khan</span> <span className="text-success"><i className="fa fa-star"></i> <i className="fa fa-star"></i> <i className="fa fa-star"></i> <i className="fa fa-star"></i> </span> </p>
