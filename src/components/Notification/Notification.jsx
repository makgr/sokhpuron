            ...
            <Fragment>
                    ...
                    <Row>
                        <Col className=" p-1 " md={6} lg={6} sm={12} xs={12}>
                            <Card onClick={this.handleShow} className="notification-card">
                                <Card.Body>
                                    ...
                                    <p className="py-1  px-0 text-primary m-0"><i className="fa  fa-bell"></i>   Date: 25/03/2023 | Status: Unread</p>
                                </Card.Body>
                            </Card>
                        </Col>
                        ...
                        <Col className="p-1" md={6} lg={6} sm={12} xs={12}>
                            <Card className="notification-card">
                                <Card.Body>
                                    <h6> Lorem Ipsum is simply dummy text of the printing</h6>
                                    <p className="py-1  px-0 text-success m-0"><i className="fa  fa-bell"></i>   Date: 25/03/2023 | Status: Read</p>
                                </Card.Body>
                            </Card>
                ...
                <Modal show={this.state.show} onHide={this.handleClose}>
                    <Modal.Header closeButton>
                        <h6><i className="fa fa-bell"></i> Date:25/03/2023</h6>
                    </Modal.Header>
                    <Modal.Body>
